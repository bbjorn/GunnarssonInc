...
> = {
  takeover: {
    predictions: [
      ...
      "Rumors of hostile bid from NeoNET partners",
  ...
  volatility: {
    predictions: [
      ...
      "Renraku AI trading bot detected in market",
      "Saeder-Krupp divests from biotech sector",
      "NeoNET algorithm triggers flash crash warning",
    ...
    messages: [
      ...
      "Consult with NeoNET for flash crash protocols.",
  ...
  "ice breach": {
    predictions: [
      ...
      "NeoNET exploit attempt blocked by firewall",
    ...
    messages: [
      ...
      "Consult with NeoNET for exploit mitigation.",
  ...
  "supply chain": {
    predictions: [
      ...
      "NeoNET logistics system outage",
    ...
    messages: [
      ...
      "Contact NeoNET for logistics system status.",
  ...
  loyalty: {
    predictions: [
      ...
      "NeoNET job offer intercepted in email scan",
    ...
    messages: [
      ...
      "Consult with NeoNET for job offer protocols.",
  ...
  uplink: {
    predictions: [
      ...
      "NeoNET uplink handshake failed",
    ...
    messages: [
      ...
      "Consult with NeoNET for handshake protocols.",
